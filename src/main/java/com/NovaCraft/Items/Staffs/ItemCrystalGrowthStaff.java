...
//----------------------------------------------------------------------------------------------------------------
		...
		//----------------------------------------------------------------------------------------------------------------
		if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 1) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 7) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_2 && meta == 1) {
		...
		//side 1
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 4) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 10) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_2 && meta == 4) {
		...
		//side 2
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 5) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 11) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_2 && meta == 5) {
		...
		//top
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 0) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 6) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_2 && meta == 0) {
		...
		//side
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 3) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 9) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_2 && meta == 3) {
		...
		//side
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 2) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_1 && meta == 8) {
		...
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.aether_cluster_2 && meta == 2) {
		...
		//----------------------------------------------------------------------------------------------------------------
		if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 1 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_1, 7, 7);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 7 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 1, 1);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_2 && meta == 1 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 7, 7);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}
		//side 1
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 4 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_1, 10, 10);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 10 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 4, 4);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_2 && meta == 4 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 10, 10);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}
		...
		//side 2
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 5 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_1, 11, 11);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 11 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 5, 5);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_2 && meta == 5 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 11, 11);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}
		...
		//top
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 0 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_1, 6, 6);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 6 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 0, 0);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_2 && meta == 0 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 6, 6);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}
		...
		//side
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 3 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_1, 9, 9);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 9 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 3, 3);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_2 && meta == 3 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 9, 9);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}
		...
		//side
		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 2 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_1, 8, 89);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_1 && meta == 8 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 2, 2);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}

		else if (world.getBlock(x, y, z) == NovaCraftBlocks.null_cluster_2 && meta == 2 && world.provider.dimensionId == 1) {

			world.setBlock(x, y, z, NovaCraftBlocks.null_cluster_2, 8, 8);
			world.playSoundEffect(x, y, z, "nova_craft:crystal.shimmer", 2.0F, world.rand.nextFloat() - world.rand.nextFloat() * 0.2F + 1.2F);
			heldItem.damageItem(10, player);
			player.triggerAchievement(AchievementsNovaCraft.speeding_the_rates);
		}
