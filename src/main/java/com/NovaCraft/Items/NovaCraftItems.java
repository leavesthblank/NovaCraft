...
import com.NovaCraft.Items.Armor.ItemIridiumBoots;
import com.NovaCraft.Items.Armor.ItemIridiumChestplate;
import com.NovaCraft.Items.Armor.ItemIridiumHelmet;
import com.NovaCraft.Items.Armor.ItemIridiumLeggings;
...
public class NovaCraftItems {
	...
	public static void initialization() {
		...
		raw_iridium = register("raw_iridium", new ItemFireproof().setTextureName(NovaCraft.find("raw_iridium")));
		iridium_ingot = register("iridium_ingot", new ItemFireproof().setTextureName(NovaCraft.find("iridium_ingot")));
		...
		echo_eye = register("echo_eye", new ItemEchoEye().setTextureName(NovaCraft.find("echo_eye")));
		...
		cooked_frog_leg = register("cooked_frog_leg", new ItemCookedFrogLeg().setTextureName(NovaCraft.find("cooked_frog_leg")));
		...
		iridium_sword = register("iridium_sword", new ItemIridiumSword().setTextureName(NovaCraft.find("iridium_sword")));
		iridium_pickaxe = register("iridium_pickaxe", new ItemIridiumPickaxe().setTextureName(NovaCraft.find("iridium_pickaxe")));
		iridium_axe = register("iridium_axe", new ItemIridiumAxe().setTextureName(NovaCraft.find("iridium_axe")));
		iridium_shovel = register("iridium_shovel", new ItemIridiumShovel().setTextureName(NovaCraft.find("iridium_shovel")));
		iridium_hoe = register("iridium_hoe", new ItemIridiumHoe().setTextureName(NovaCraft.find("iridium_hoe")));
		
		iridium_helmet = register("iridium_helmet", new ItemIridiumHelmet().setTextureName(NovaCraft.find("iridium_helmet")));
