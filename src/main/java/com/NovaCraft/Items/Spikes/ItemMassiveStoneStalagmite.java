...
public class ItemMassiveStoneStalagmite extends Item {

    public ItemMassiveStoneStalagmite() {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
        ...
        Block lowerBlock = NovaCraftBlocks.massive_stone_stalagmite_bottom;
        Block upperBlock = NovaCraftBlocks.massive_stone_stalagmite_top;
