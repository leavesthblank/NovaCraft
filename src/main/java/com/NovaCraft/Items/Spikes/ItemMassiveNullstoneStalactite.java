...
public class ItemMassiveNullstoneStalactite extends Item {

    public ItemMassiveNullstoneStalactite() {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
        ...
        Block lowerBlock = NovaCraftBlocks.massive_nullstone_stalactite_top;
        Block upperBlock = NovaCraftBlocks.massive_nullstone_stalactite_bottom;
