...
public class ItemMassiveStoneStalactite extends Item {

    public ItemMassiveStoneStalactite() {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
        ...
        Block lowerBlock = NovaCraftBlocks.massive_stone_stalactite_top;
        Block upperBlock = NovaCraftBlocks.massive_stone_stalactite_bottom;
