...
public class VindicatorHouseSmallNoDoor extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i, j + 1, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 1, k + 2, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 1, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 1, k + 4, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 1, k + 5, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 2, k, air);
		world.setBlock(i, j + 2, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 2, k + 2, planks, 5, 2);
		world.setBlock(i, j + 2, k + 3, planks, 5, 2);
		world.setBlock(i, j + 2, k + 4, planks, 5, 2);
		world.setBlock(i, j + 2, k + 5, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 3, k, air);
		world.setBlock(i, j + 3, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 3, k + 2, planks, 5, 2);
		world.setBlock(i, j + 3, k + 3, thinGlass, 0, 2);
		world.setBlock(i, j + 3, k + 4, planks, 5, 2);
		world.setBlock(i, j + 3, k + 5, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 4, k, air);
		world.setBlock(i, j + 4, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 4, k + 2, planks, 5, 2);
		world.setBlock(i, j + 4, k + 3, planks, 5, 2);
		world.setBlock(i, j + 4, k + 4, planks, 5, 2);
		world.setBlock(i, j + 4, k + 5, cobbledGrimstone, 0, 2);
		world.setBlock(i, j + 5, k, air);
		world.setBlock(i, j + 5, k + 1, wood, 1, 2);
		world.setBlock(i, j + 5, k + 2, wood, 1, 2);
		world.setBlock(i, j + 5, k + 3, wood, 1, 2);
		world.setBlock(i, j + 5, k + 4, wood, 1, 2);
		world.setBlock(i, j + 5, k + 5, wood, 1, 2);
		...
		world.setBlock(i + 2, j + 1, k, NovaCraftBlocks.cobbled_grimstone_stairs, 2, 2);
