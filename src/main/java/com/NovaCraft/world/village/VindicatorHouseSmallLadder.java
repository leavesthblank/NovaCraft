...
public class VindicatorHouseSmallLadder extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i, j, k + 1, air);
		world.setBlock(i, j, k + 2, NovaCraftBlocks.cobbled_grimstone_stairs, 0, 2);
		world.setBlock(i, j, k + 3, air);
		world.setBlock(i, j, k + 4, air);
		...
		world.setBlock(i + 1, j, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 1, j + 1, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 1, j + 2, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 1, j + 3, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 1, j + 4, k, wood, 1, 2);
		...
		world.setBlock(i + 1, j + 5, k, fence, 0, 2);
		...
		world.setBlock(i + 2, j, k, cobbledGrimstone, 0, 2);
		world.setBlock(i + 2, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 2, j, k + 2, cobbledGrimstone, 0, 2);
		world.setBlock(i + 2, j, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i + 2, j, k + 4, cobbledGrimstone, 0, 2);
		world.setBlock(i + 2, j + 1, k, planks, 5, 2);
		...
		world.setBlock(i + 2, j + 2, k, planks, 5, 2);
		...
		world.setBlock(i + 2, j + 5, k, fence, 0, 2);
		...
		world.setBlock(i + 3, j, k, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j, k + 2, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j, k + 4, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j + 1, k, planks, 5, 2);
		...
		world.setBlock(i + 3, j + 2, k, thinGlass, 0, 2);
		...
		world.setBlock(i + 3, j + 3, k, planks, 5, 2);
		...
		world.setBlock(i + 3, j + 4, k, wood, 1, 2);
		...
		world.setBlock(i + 3, j + 5, k, fence, 0, 2);
		...
		world.setBlock(i + 4, j, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 5, j, k, cobbledGrimstone, 0, 2);
		world.setBlock(i + 5, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 5, j, k + 2, cobbledGrimstone, 0, 2);
		world.setBlock(i + 5, j, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i + 5, j, k + 4, cobbledGrimstone, 0, 2);
		world.setBlock(i + 5, j + 1, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 5, j + 2, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 5, j + 3, k, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 5, j + 4, k, wood, 1, 2);
		...
		world.setBlock(i + 5, j + 5, k, fence, 0, 2);
