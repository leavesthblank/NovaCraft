...
public class VindicatorFarm extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i, j, k, wood, 0, 2);
		world.setBlock(i, j, k + 1, wood, 0, 2);
		world.setBlock(i, j, k + 2, wood, 0, 2);
		world.setBlock(i, j, k + 3, wood, 0, 2);
		world.setBlock(i, j, k + 4, wood, 0, 2);
		world.setBlock(i, j, k + 5, wood, 0, 2);
		world.setBlock(i, j, k + 6, wood, 0, 2);
		world.setBlock(i, j, k + 7, wood, 0, 2);
		world.setBlock(i, j, k + 8, wood, 0, 2);
		...
		world.setBlock(i + 1, j, k, wood, 0, 2);
		world.setBlock(i + 1, j, k + 1, tilledField, 7, 2);
		world.setBlock(i + 1, j, k + 2, tilledField, 7, 2);
		world.setBlock(i + 1, j, k + 3, tilledField, 0, 2);
		world.setBlock(i + 1, j, k + 4, tilledField, 0, 2);
		world.setBlock(i + 1, j, k + 5, tilledField, 7, 2);
		world.setBlock(i + 1, j, k + 6, tilledField, 7, 2);
		world.setBlock(i + 1, j, k + 7, tilledField, 7, 2);
		world.setBlock(i + 1, j, k + 8, wood, 0, 2);
		world.setBlock(i + 1, j + 1, k, air);
		world.setBlock(i + 1, j + 1, k + 8, air);
		world.setBlock(i + 2, j, k, wood, 0, 2);
		world.setBlock(i + 2, j, k + 1, tilledField, 0, 2);
		world.setBlock(i + 2, j, k + 2, tilledField, 0, 2);
		world.setBlock(i + 2, j, k + 3, tilledField, 0, 2);
		world.setBlock(i + 2, j, k + 4, tilledField, 7, 2);
		world.setBlock(i + 2, j, k + 5, tilledField, 0, 2);
		world.setBlock(i + 2, j, k + 6, tilledField, 7, 2);
		world.setBlock(i + 2, j, k + 7, tilledField, 7, 2);
		world.setBlock(i + 2, j, k + 8, wood, 0, 2);
		world.setBlock(i + 2, j + 1, k, air);
		world.setBlock(i + 2, j + 1, k + 8, air);
		world.setBlock(i + 3, j, k, wood, 0, 2);
		world.setBlock(i + 3, j, k + 8, wood, 0, 2);
		world.setBlock(i + 3, j + 1, k, air);
		...
		world.setBlock(i + 4, j, k, wood, 0, 2);
		world.setBlock(i + 4, j, k + 1, tilledField, 7, 2);
		world.setBlock(i + 4, j, k + 2, tilledField, 0, 2);
		world.setBlock(i + 4, j, k + 3, tilledField, 7, 2);
		world.setBlock(i + 4, j, k + 4, tilledField, 7, 2);
		world.setBlock(i + 4, j, k + 5, tilledField, 7, 2);
		world.setBlock(i + 4, j, k + 6, tilledField, 7, 2);
		world.setBlock(i + 4, j, k + 7, tilledField, 7, 2);
		world.setBlock(i + 4, j, k + 8, wood, 0, 2);
		world.setBlock(i + 4, j + 1, k, air);
		world.setBlock(i + 4, j + 1, k + 8, air);
		world.setBlock(i + 5, j, k, wood, 0, 2);
		world.setBlock(i + 5, j, k + 1, tilledField, 7, 2);
		world.setBlock(i + 5, j, k + 2, tilledField, 7, 2);
		world.setBlock(i + 5, j, k + 3, tilledField, 7, 2);
		world.setBlock(i + 5, j, k + 4, tilledField, 7, 2);
		world.setBlock(i + 5, j, k + 5, tilledField, 0, 2);
		world.setBlock(i + 5, j, k + 6, tilledField, 7, 2);
		world.setBlock(i + 5, j, k + 7, tilledField, 7, 2);
		world.setBlock(i + 5, j, k + 8, wood, 0, 2);
		world.setBlock(i + 5, j + 1, k, air);
		world.setBlock(i + 5, j + 1, k + 8, air);
		world.setBlock(i + 6, j, k, wood, 0, 2);
		world.setBlock(i + 6, j, k + 1, wood, 0, 2);
		world.setBlock(i + 6, j, k + 2, wood, 0, 2);
		world.setBlock(i + 6, j, k + 3, wood, 0, 2);
		world.setBlock(i + 6, j, k + 4, wood, 0, 2);
		world.setBlock(i + 6, j, k + 5, wood, 0, 2);
		world.setBlock(i + 6, j, k + 6, wood, 0, 2);
		world.setBlock(i + 6, j, k + 7, wood, 0, 2);
		world.setBlock(i + 6, j, k + 8, wood, 0, 2);
		world.setBlock(i + 6, j + 1, k, air);
		...
		world.setBlock(i + 7, j, k, wood, 0, 2);
		world.setBlock(i + 7, j, k + 1, tilledField, 0, 2);
		world.setBlock(i + 7, j, k + 2, tilledField, 7, 2);
		world.setBlock(i + 7, j, k + 3, tilledField, 0, 2);
		world.setBlock(i + 7, j, k + 4, tilledField, 7, 2);
		world.setBlock(i + 7, j, k + 5, tilledField, 7, 2);
		world.setBlock(i + 7, j, k + 6, tilledField, 0, 2);
		world.setBlock(i + 7, j, k + 7, tilledField, 7, 2);
		world.setBlock(i + 7, j, k + 8, wood, 0, 2);
		world.setBlock(i + 7, j + 1, k, air);
		world.setBlock(i + 7, j + 1, k + 8, air);
		world.setBlock(i + 8, j, k, wood, 0, 2);
		world.setBlock(i + 8, j, k + 1, tilledField, 7, 2);
		world.setBlock(i + 8, j, k + 2, tilledField, 7, 2);
		world.setBlock(i + 8, j, k + 3, tilledField, 7, 2);
		world.setBlock(i + 8, j, k + 4, tilledField, 7, 2);
		world.setBlock(i + 8, j, k + 5, tilledField, 7, 2);
		world.setBlock(i + 8, j, k + 6, tilledField, 7, 2);
		world.setBlock(i + 8, j, k + 7, tilledField, 0, 2);
		world.setBlock(i + 8, j, k + 8, wood, 0, 2);
		world.setBlock(i + 8, j + 1, k, air);
		world.setBlock(i + 8, j + 1, k + 8, air);
		world.setBlock(i + 9, j, k, wood, 0, 2);
		world.setBlock(i + 9, j, k + 8, wood, 0, 2);
		world.setBlock(i + 9, j + 1, k, air);
		...
		world.setBlock(i + 10, j, k, wood, 0, 2);
		world.setBlock(i + 10, j, k + 1, tilledField, 7, 2);
		world.setBlock(i + 10, j, k + 2, tilledField, 7, 2);
		world.setBlock(i + 10, j, k + 3, tilledField, 7, 2);
		world.setBlock(i + 10, j, k + 4, tilledField, 7, 2);
		world.setBlock(i + 10, j, k + 5, tilledField, 7, 2);
		world.setBlock(i + 10, j, k + 6, tilledField, 0, 2);
		world.setBlock(i + 10, j, k + 7, tilledField, 0, 2);
		world.setBlock(i + 10, j, k + 8, wood, 0, 2);
		world.setBlock(i + 10, j + 1, k, air);
		world.setBlock(i + 10, j + 1, k + 8, air);
		world.setBlock(i + 11, j, k, wood, 0, 2);
		world.setBlock(i + 11, j, k + 1, tilledField, 7, 2);
		world.setBlock(i + 11, j, k + 2, tilledField, 7, 2);
		world.setBlock(i + 11, j, k + 3, tilledField, 7, 2);
		world.setBlock(i + 11, j, k + 4, tilledField, 0, 2);
		world.setBlock(i + 11, j, k + 5, tilledField, 7, 2);
		world.setBlock(i + 11, j, k + 6, tilledField, 0, 2);
		world.setBlock(i + 11, j, k + 7, tilledField, 0, 2);
		world.setBlock(i + 11, j, k + 8, wood, 0, 2);
		world.setBlock(i + 11, j + 1, k, air);
		world.setBlock(i + 11, j + 1, k + 8, air);
		world.setBlock(i + 12, j, k, wood, 0, 2);
		world.setBlock(i + 12, j, k + 1, wood, 0, 2);
		world.setBlock(i + 12, j, k + 2, wood, 0, 2);
		world.setBlock(i + 12, j, k + 3, wood, 0, 2);
		world.setBlock(i + 12, j, k + 4, wood, 0, 2);
		world.setBlock(i + 12, j, k + 5, wood, 0, 2);
		world.setBlock(i + 12, j, k + 6, wood, 0, 2);
		world.setBlock(i + 12, j, k + 7, wood, 0, 2);
		world.setBlock(i + 12, j, k + 8, wood, 0, 2);
		world.setBlock(i + 12, j + 1, k, air);
		...
		world.setBlock(i + 3, j, k + 1, water, 0, 2);
		world.setBlock(i + 3, j, k + 2, water, 0, 2);
		world.setBlock(i + 3, j, k + 3, water, 0, 2);
		world.setBlock(i + 3, j, k + 4, water, 0, 2);
		world.setBlock(i + 3, j, k + 5, water, 0, 2);
		world.setBlock(i + 3, j, k + 6, water, 0, 2);
		world.setBlock(i + 3, j, k + 7, water, 0, 2);
		...
		world.setBlock(i + 9, j, k + 1, water, 0, 2);
		world.setBlock(i + 9, j, k + 2, water, 0, 2);
		world.setBlock(i + 9, j, k + 3, water, 0, 2);
		world.setBlock(i + 9, j, k + 4, water, 0, 2);
		world.setBlock(i + 9, j, k + 5, water, 0, 2);
		world.setBlock(i + 9, j, k + 6, water, 0, 2);
		world.setBlock(i + 9, j, k + 7, water, 0, 2);
