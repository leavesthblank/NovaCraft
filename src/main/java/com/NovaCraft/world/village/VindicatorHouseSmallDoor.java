...
public class VindicatorHouseSmallDoor extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i, j + 1, k + 1, NovaCraftBlocks.cobbled_grimstone_stairs, 0, 2);
		...
		world.setBlock(i + 3, j + 1, k, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j + 1, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j + 2, k, planks, 0, 2);
