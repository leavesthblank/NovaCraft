...
public class VindicatorWell extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 1, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 1, j, k + 2, cobbledGrimstone, 0, 2);
		world.setBlock(i + 1, j, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i + 1, j, k + 4, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 2, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 2, j, k + 4, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 3, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 3, j, k + 4, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 4, j, k + 1, cobbledGrimstone, 0, 2);
		world.setBlock(i + 4, j, k + 2, cobbledGrimstone, 0, 2);
		world.setBlock(i + 4, j, k + 3, cobbledGrimstone, 0, 2);
		world.setBlock(i + 4, j, k + 4, cobbledGrimstone, 0, 2);
		...
		world.setBlock(i + 5, j + 4, k + 5, air);
		{
			try {
				if (Loader.isModLoaded("netherlicious")) {
					world.setBlock(i, j, k, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i, j, k + 1, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i, j, k + 2, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i, j, k + 3, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i, j, k + 4, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i, j, k + 5, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 1, j, k, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 1, j, k + 5, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 2, j, k, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 2, j, k + 5, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 3, j, k, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 3, j, k + 5, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 4, j, k, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 4, j, k + 5, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 5, j, k, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 5, j, k + 1, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 5, j, k + 2, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 5, j, k + 3, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 5, j, k + 4, OtherModBlocks.Nether_Gravel, 0, 2);
					world.setBlock(i + 5, j, k + 5, OtherModBlocks.Nether_Gravel, 0, 2);
				} else {
					world.setBlock(i, j, k, Blocks.gravel, 0, 2);
					world.setBlock(i, j, k + 1, Blocks.gravel, 0, 2);
					world.setBlock(i, j, k + 2, Blocks.gravel, 0, 2);
					world.setBlock(i, j, k + 3, Blocks.gravel, 0, 2);
					world.setBlock(i, j, k + 4, Blocks.gravel, 0, 2);
					world.setBlock(i, j, k + 5, Blocks.gravel, 0, 2);
					world.setBlock(i + 1, j, k, Blocks.gravel, 0, 2);
					world.setBlock(i + 1, j, k + 5, Blocks.gravel, 0, 2);
					world.setBlock(i + 2, j, k, Blocks.gravel, 0, 2);
					world.setBlock(i + 2, j, k + 5, Blocks.gravel, 0, 2);
					world.setBlock(i + 3, j, k, Blocks.gravel, 0, 2);
					world.setBlock(i + 3, j, k + 5, Blocks.gravel, 0, 2);
					world.setBlock(i + 4, j, k, Blocks.gravel, 0, 2);
					world.setBlock(i + 4, j, k + 5, Blocks.gravel, 0, 2);
					world.setBlock(i + 5, j, k, Blocks.gravel, 0, 2);
					world.setBlock(i + 5, j, k + 1, Blocks.gravel, 0, 2);
					world.setBlock(i + 5, j, k + 2, Blocks.gravel, 0, 2);
					world.setBlock(i + 5, j, k + 3, Blocks.gravel, 0, 2);
					world.setBlock(i + 5, j, k + 4, Blocks.gravel, 0, 2);
					world.setBlock(i + 5, j, k + 5, Blocks.gravel, 0, 2);
				}
			} catch (Exception ex) {
		...
		world.setBlock(i + 2, j, k + 2, Blocks.water, 0, 2);
		world.setBlock(i + 2, j, k + 3, Blocks.water, 0, 2);
		world.setBlock(i + 3, j, k + 2, Blocks.water, 0, 2);
		world.setBlock(i + 3, j, k + 3, Blocks.water, 0, 2);
