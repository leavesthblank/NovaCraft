            ...
            for (int dz = -radiusInt; dz <= radiusInt; ++dz) {
                ...
                if (horizDistSq <= (double)(radius * radius)) {
                    ...
                    if (floorY > 0) {
                                ...
                                if (chance < 0.5F) {
                                    ...
                                    if (Loader.isModLoaded("etfuturum")) {
                                        try {
                                            ...
                                            bottomBlock = coarse_dirt != null ? coarse_dirt : Blocks.dirt;
                        ...
                        if (world.isAirBlock(realX, floorY + 1, realZ)
                                && target.getMaterial().isSolid()
                                && target != Blocks.log
                                && target != Blocks.log2
                                && target != Blocks.leaves
                                && target != Blocks.leaves2) {
