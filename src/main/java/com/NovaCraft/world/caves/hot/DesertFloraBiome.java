...
public class DesertFloraBiome extends BasicUndergroundBiomeNearSurface {

    public static boolean useSandstone;
    public static double FloraChance;
    public static double OtherBlocksChance;

    public DesertFloraBiome() {
        super(Blocks.sandstone, null, null, 0, 0, 0, true);
    }
    ...
    public void fillCeiling(World world, int x, int y, int z, Block block) {
        ...
        world.setBlock(x, y, z, Blocks.sandstone, 0, 2);
    }
    ...
    public void fillFloor(World world, int x, int y, int z, Block block) {
        ...
        int chance = 1 + world.rand.nextInt(5);
        ...
        switch (chance) {
            case 1:
                ...
                break;
            case 2:
                placeBlockFloor = NovaCraftBlocks.desert_bloom;
                break;
            default:
                placeBlockFloor = NovaCraftBlocks.blooming_barb;
                break;
        }
        ...
        if (FloraChance > 0 && world.rand.nextDouble() < FloraChance) {
            ...
            for (int i = 0; i < height; i++) {
                int yy = y + 1 + i;
                if (world.getBlock(x, y + 1, z).isAir(world, x, y + 1, z) && !canSeeSky(world, x, yy, z))
        ...
        Block placeBlockAlternate = Blocks.sand;
        ...
        switch (chance_alternate) {
            ...
            case 2:
                if (Loader.isModLoaded("etfuturum")) {
                    ...
                    placeBlockAlternate = Blocks.sand;
                }
                break;
            default:
                placeBlockAlternate = Blocks.sand;
