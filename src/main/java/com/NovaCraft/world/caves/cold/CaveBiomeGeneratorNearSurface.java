...
public class CaveBiomeGeneratorNearSurface extends MultiChunkFeatureGeneratorNearSurface {

    public final UndergroundBiomeNearSurface biome;
    ...
    private static final int BLOBS_CELL_SIZE = 40;     // bigger = thicker, larger patches
    ...
    public CaveBiomeGeneratorNearSurface(UndergroundBiomeNearSurface biome, int rarity, int minXSize, int minYSize, int minZSize,
    ...
    public void apply(World world, int centerX, int centerY, int centerZ,
        ...
        CaveBiomeGeneratorNearSurface.UndergroundBiomeGenerationContext context = new CaveBiomeGeneratorNearSurface.UndergroundBiomeGenerationContext();
        ...
        forEachChunkBlock(chunkX, chunkZ, centerY - radiusY, centerY + radiusY, (pos) -> {
            ...
            if (APPLY_Y_CULL) {
                if (pos.y < 72) {
                    if (pos.y < 46 || random.nextFloat() > 0.33f) return;
                }
            }
    ...
    public static class UndergroundBiomeData {
        public UndergroundBiomeData(UndergroundBiomeNearSurface biome, int rarity,
