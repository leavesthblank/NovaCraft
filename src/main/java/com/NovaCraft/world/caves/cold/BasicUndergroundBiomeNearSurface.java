...
public class BasicUndergroundBiomeNearSurface extends UndergroundBiomeNearSurface {

    public Block floorBlock, ceilingBlock, wallBlock;
    public int floorMeta, ceilingMeta, wallMeta;
    public final boolean mimicInside;

    public BasicUndergroundBiomeNearSurface(Block floorBlock, Block ceilingBlock, Block wallBlock) {
        this(floorBlock, ceilingBlock, wallBlock, 0, 0, 0, false);
    }

    public BasicUndergroundBiomeNearSurface(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta) {
        this(floorBlock, ceilingBlock, wallBlock, floorMeta, ceilingMeta, wallMeta, false);
    }

    public BasicUndergroundBiomeNearSurface(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta, boolean mimicInside) {
