...
public class BasicUndergroundBiome extends UndergroundBiome {
    ...
    public BasicUndergroundBiome(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta) {
        this(floorBlock, ceilingBlock, wallBlock, floorMeta, ceilingMeta, wallMeta, false);
    }

    public BasicUndergroundBiome(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta, boolean mimicInside) {
