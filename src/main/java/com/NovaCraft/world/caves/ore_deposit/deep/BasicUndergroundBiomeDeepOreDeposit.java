...
public class BasicUndergroundBiomeDeepOreDeposit extends UndergroundBiomeDeepOreDeposit {

    public Block floorBlock, ceilingBlock, wallBlock;
    public int floorMeta, ceilingMeta, wallMeta;
    public final boolean mimicInside;

    public BasicUndergroundBiomeDeepOreDeposit(Block floorBlock, Block ceilingBlock, Block wallBlock) {
        this(floorBlock, ceilingBlock, wallBlock, 0, 0, 0, false);
    }

    public BasicUndergroundBiomeDeepOreDeposit(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta) {
        this(floorBlock, ceilingBlock, wallBlock, floorMeta, ceilingMeta, wallMeta, false);
    }

    public BasicUndergroundBiomeDeepOreDeposit(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta, boolean mimicInside) {
