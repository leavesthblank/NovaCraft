...
public class NullstoneStalgStacCaveBiome extends BasicUndergroundBiomeDeepOreDeposit {

    public static boolean useOre;
    public static double StagChance;
    public static double StacChance;

    public NullstoneStalgStacCaveBiome() {
        super(NovaCraftBlocks.nullstone, null, null, 0, 0, 0, true);
    }

    private static boolean canReplace(Block block) {
        if (block == null) return false;
        String name = block.getUnlocalizedName();
        return name != null && (name.toLowerCase(Locale.ROOT).contains("null")) && !(name.toLowerCase(Locale.ROOT).contains("ore")) && !(name.toLowerCase(Locale.ROOT).contains("dirt"))
    ...
    public void fillCeiling(World world, int x, int y, int z, Block block) {
        ...
        world.setBlock(x, y, z, NovaCraftBlocks.nullstone, 0, 2);
    }
    ...
    public void fillFloor(World world, int x, int y, int z, Block block) {
        ...
        switch (chance / 20) {
            case 0:
                ...
                break;
            case 1:
                placeBlockBottom = NovaCraftBlocks.large_nullstone_stalagmite;
                break;
            case 2:
                placeBlockBottom = NovaCraftBlocks.hydnum_mushroom;
                break;
            case 3:
            ...
            case 4:
                ...
                break;
            default:
                placeBlockBottom = NovaCraftBlocks.nullstone_stalagmite;
                break;
        }
        ...
        if (chance_top / 20 == 0) {
            placeBlockTop = NovaCraftBlocks.nullstone_stalactite;
        } else if (chance_top / 20 == 1) {
            placeBlockTop = NovaCraftBlocks.massive_nullstone_stalactite_top;
        } else {
            placeBlockTop = NovaCraftBlocks.large_nullstone_stalactite;
        }
        ...
        Block placeLichen = NovaCraftBlocks.dark_lichen;
