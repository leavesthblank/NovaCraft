...
public abstract class UndergroundBiomeStalgStacCave {

    public double dungeonChance;

    public void fill(World world, int x, int y, int z, CaveBiomeGeneratorStalgStacCave.UndergroundBiomeGenerationContext context) {
