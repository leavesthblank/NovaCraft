...
public class CaveBiomeGeneratorStalgStacCave extends MultiChunkFeatureGeneratorStagStacCave {

    public final UndergroundBiomeStalgStacCave biome;
    ...
    public CaveBiomeGeneratorStalgStacCave(UndergroundBiomeStalgStacCave biome, int rarity, int minXSize, int minYSize, int minZSize,
    ...
    public void apply(World world, int centerX, int centerY, int centerZ,
        ...
        com.NovaCraft.world.caves.ore_deposit.dripstone_alternatives.CaveBiomeGeneratorStalgStacCave.UndergroundBiomeGenerationContext context = new com.NovaCraft.world.caves.ore_deposit.dripstone_alternatives.CaveBiomeGeneratorStalgStacCave.UndergroundBiomeGenerationContext();
        ...
        forEachChunkBlock(chunkX, chunkZ, centerY - radiusY, centerY + radiusY, (pos) -> {
            ...
            if (APPLY_Y_CULL) {
                if (pos.y > 52) {
                    if (pos.y < 56 || random.nextFloat() > 0.25f) return;
                }
            }
    ...
    public static class UndergroundBiomeData {
        public UndergroundBiomeData(UndergroundBiomeStalgStacCave biome, int rarity,
