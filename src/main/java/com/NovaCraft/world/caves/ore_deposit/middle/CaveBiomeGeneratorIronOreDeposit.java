...
public class CaveBiomeGeneratorIronOreDeposit extends MultiChunkFeatureGeneratorIronOreDeposit {

    public final UndergroundBiomeIronOreDeposit biome;
    ...
    public CaveBiomeGeneratorIronOreDeposit(UndergroundBiomeIronOreDeposit biome, int rarity, int minXSize, int minYSize, int minZSize,
    ...
    public void apply(World world, int centerX, int centerY, int centerZ,
        ...
        CaveBiomeGeneratorIronOreDeposit.UndergroundBiomeGenerationContext context = new CaveBiomeGeneratorIronOreDeposit.UndergroundBiomeGenerationContext();
        ...
        forEachChunkBlock(chunkX, chunkZ, centerY - radiusY, centerY + radiusY, (pos) -> {
            ...
            if (APPLY_Y_CULL) {
                if (pos.y < 42) {
                    if (pos.y < 40 || random.nextFloat() > 0.33f) return;
                }
            }
    ...
    public static class UndergroundBiomeData {
        public UndergroundBiomeData(UndergroundBiomeIronOreDeposit biome, int rarity,
