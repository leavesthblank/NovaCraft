...
public class RedstoneDeposit extends BasicUndergroundBiomeDeepOreDeposit {

    public static boolean useOre;
    public static double FloraChance;
    public static double OtherBlocksChance;

    public RedstoneDeposit() {
        super(NovaCraftBlocks.grimstone_redstone, null, null, 0, 0, 0, true);
    }
    ...
    public void fillCeiling(World world, int x, int y, int z, Block block) {
        ...
        world.setBlock(x, y, z, NovaCraftBlocks.grimstone_redstone, 0, 2);
    }
    ...
    public void fillFloor(World world, int x, int y, int z, Block block) {
        ...
        if (chance == 1) {
            placeBlockFloor = NovaCraftBlocks.calvatia_mushroom;
        } else {
        ...
        Block placeBlockAlternate = Blocks.redstone_ore;
        int chance_alternate = 1 + world.rand.nextInt(4);

        switch (chance_alternate) {
            case 1:
                placeBlockAlternate = NovaCraftBlocks.nullstone_redstone;
                break;
            case 2:
