...
public abstract class UndergroundBiomeIronOreDeposit {

    public double dungeonChance;

    public void fill(World world, int x, int y, int z, CaveBiomeGeneratorIronOreDeposit.UndergroundBiomeGenerationContext context) {
