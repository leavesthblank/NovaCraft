...
public abstract class UndergroundBiomeDeepOreDeposit {

    public double dungeonChance;

    public void fill(World world, int x, int y, int z, CaveBiomeGeneratorDeepOreDeposit.UndergroundBiomeGenerationContext context) {
