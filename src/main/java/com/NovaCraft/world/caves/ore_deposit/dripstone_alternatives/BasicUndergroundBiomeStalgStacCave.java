...
public class BasicUndergroundBiomeStalgStacCave extends UndergroundBiomeStalgStacCave {

    public Block floorBlock, ceilingBlock, wallBlock;
    public int floorMeta, ceilingMeta, wallMeta;
    public final boolean mimicInside;

    public BasicUndergroundBiomeStalgStacCave(Block floorBlock, Block ceilingBlock, Block wallBlock) {
        this(floorBlock, ceilingBlock, wallBlock, 0, 0, 0, false);
    }

    public BasicUndergroundBiomeStalgStacCave(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta) {
        this(floorBlock, ceilingBlock, wallBlock, floorMeta, ceilingMeta, wallMeta, false);
    }

    public BasicUndergroundBiomeStalgStacCave(Block floorBlock, Block ceilingBlock, Block wallBlock, int floorMeta, int ceilingMeta, int wallMeta, boolean mimicInside) {
