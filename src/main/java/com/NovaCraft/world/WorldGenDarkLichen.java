...
public class WorldGenDarkLichen extends WorldGenerator {
    ...
    public WorldGenDarkLichen(Block block)
    {
    ...
    public boolean generate(World world, Random random, int x, int y, int z)
    {
        for (int l = 0; l < this.GroupSize; ++l)
        {
            ...
            if (world.isAirBlock(i1, j1, k1) && world.getBlock(i1, j1 +1, k1) != NovaCraftBlocks.dark_lichen && world.getBlock(i1, j1 +1, k1).isSideSolid(world, i1, j1 +1, k1, ForgeDirection.getOrientation(0))) {
            	world.setBlock(i1, j1, k1, this.Lichen, 0, 2);
            }
            	...
            	world.setBlock(i1, j1, k1, this.Lichen, 1, 2);
            }
            	...
            	world.setBlock(i1, j1, k1, this.Lichen, 2, 2);
            }
            	...
            	world.setBlock(i1, j1, k1, this.Lichen, 3, 2);
            }
            	...
            	world.setBlock(i1, j1, k1, this.Lichen, 4, 2);
            }
            	...
            	world.setBlock(i1, j1, k1, this.Lichen, 5, 2);
            }
