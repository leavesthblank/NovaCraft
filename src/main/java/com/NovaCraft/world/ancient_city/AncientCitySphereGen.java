        ...
        for (int x1 = - 55; x1 <= 55; x1++) {
            for (int y1 = - 17; y1 <=  17; y1++) {
                for (int z1 = - 55; z1 <= 55; z1++) {
                    ...
                    double ellipsoidEquation = (Math.pow(x1, 2) / Math.pow(55, 2)) + (Math.pow(y1, 2) / Math.pow(17, 2)) + (Math.pow(z1, 2) / Math.pow(55, 2));
                    
                    //Checks if the point is inside the ellipsoid
