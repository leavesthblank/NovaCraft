...
public class AncientCitySmallHangingStructure3Gen extends WorldGenerator
{
	public AncientCitySmallHangingStructure3Gen() {
	 ...
	 public boolean generate(final World world, final Random random, final int i, final int j, final int k) {
			...
			world.setBlock(i + 2, j + 7, k, NovaCraftBlocks.nullstone_tiles, 0, 2);
			...
			world.setBlock(i, j + 7, k + 2, NovaCraftBlocks.nullstone_tiles, 0, 2);
			...
			TileEntityMobSpawner tileentitymobspawner = (TileEntityMobSpawner)world.getTileEntity(i + 2, j, k + 2);
