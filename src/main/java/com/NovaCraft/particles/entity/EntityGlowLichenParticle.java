...
public class EntityGlowLichenParticle extends EntityFX
{
    ...
    public EntityGlowLichenParticle(World world, double p_i1222_2_, double p_i1222_4_, double p_i1222_6_, double p_i1222_8_, double p_i1222_10_, double p_i1222_12_)
    {
