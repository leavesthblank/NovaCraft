...
public class NovaCraftRegistries {
	...
	private static void initializeRecipes() {
		...
		register("crimson_eye", new ItemStack(NovaCraftItems.crimson_eye), "WZW", "XYX", " V ", 'X', new ItemStack(NovaCraftItems.iridium_nugget, 0, 0), 'Y', Items.ender_eye, 'Z', NovaCraftItems.crystallized_vanite_alloy, 'W', NovaCraftItems.copartz_shard, 'V', NovaCraftItems.wyrmling_scales);
		...
		try {
			...
			if (ancient_debris != null && ConfigsCompact.enableBlockOfRawNetheriteRecipe) {
				...
				register("iridium_helmet", new ItemStack(NovaCraftItems.iridium_helmet), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_helmet, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				register("iridium_chestplate", new ItemStack(NovaCraftItems.iridium_chestplate), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_chestplate, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				register("iridium_leggings", new ItemStack(NovaCraftItems.iridium_leggings), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_leggings, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				register("iridium_boots", new ItemStack(NovaCraftItems.iridium_boots), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_boots, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				...
				register("tophinite_helmet", new ItemStack(NovaCraftItems.tophinite_helmet), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_helmet, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				register("tophinite_chestplate", new ItemStack(NovaCraftItems.tophinite_chestplate), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_chestplate, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				register("tophinite_leggings", new ItemStack(NovaCraftItems.tophinite_leggings), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_leggings, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				register("tophinite_boots", new ItemStack(NovaCraftItems.tophinite_boots), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_boots, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				...
				register("klangite_helmet", new ItemStack(NovaCraftItems.klangite_helmet), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_helmet, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
				register("klangite_chestplate", new ItemStack(NovaCraftItems.klangite_chestplate), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_chestplate, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
				register("klangite_leggings", new ItemStack(NovaCraftItems.klangite_leggings), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_leggings, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
				register("klangite_boots", new ItemStack(NovaCraftItems.klangite_boots), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', OtherModItems.netherite_boots, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
			}
			else {
				...
				register("iridium_helmet", new ItemStack(NovaCraftItems.iridium_helmet), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_helmet, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				register("iridium_chestplate", new ItemStack(NovaCraftItems.iridium_chestplate), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_chestplate, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				register("iridium_leggings", new ItemStack(NovaCraftItems.iridium_leggings), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_leggings, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				register("iridium_boots", new ItemStack(NovaCraftItems.iridium_boots), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_boots, 'Z', NovaCraftItems.reinforced_iridium_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.larimar_shard);
				...
				register("tophinite_helmet", new ItemStack(NovaCraftItems.tophinite_helmet), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_helmet, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				register("tophinite_chestplate", new ItemStack(NovaCraftItems.tophinite_chestplate), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_chestplate, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				register("tophinite_leggings", new ItemStack(NovaCraftItems.tophinite_leggings), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_leggings, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				register("tophinite_boots", new ItemStack(NovaCraftItems.tophinite_boots), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_boots, 'Z', NovaCraftItems.tophinite_gemstone, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.ionizatior_powder);
				...
				register("klangite_helmet", new ItemStack(NovaCraftItems.klangite_helmet), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_helmet, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
				register("klangite_chestplate", new ItemStack(NovaCraftItems.klangite_chestplate), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_chestplate, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
				register("klangite_leggings", new ItemStack(NovaCraftItems.klangite_leggings), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_leggings, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
				register("klangite_boots", new ItemStack(NovaCraftItems.klangite_boots), "XZX", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.diamond_nugget, 0, 2), 'Y', Items.diamond_boots, 'Z', NovaCraftItems.klangite_ingot, 'W', NovaCraftItems.superheated_magma_cream, 'V', NovaCraftItems.reinforced_vanite_ingot);
			}
		} catch (Exception ex) {
			if (Configs.enableDebugMode) {
		...
		register("crystallized_vanite_sword", new ItemStack(NovaCraftItems.crystallized_vanite_sword), "XZZ", "WYZ", "VWX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_sword, 'Z', NovaCraftItems.crystallized_vanite_alloy, 'W', NovaCraftItems.ionizatior_powder, 'V', NovaCraftItems.crimson_dragon_bone);
		register("crystallized_vanite_pickaxe", new ItemStack(NovaCraftItems.crystallized_vanite_pickaxe), "XZZ", "WYZ", "VWX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_pickaxe, 'Z', NovaCraftItems.crystallized_vanite_alloy, 'W', NovaCraftItems.ionizatior_powder, 'V', NovaCraftItems.crimson_dragon_bone);
		register("crystallized_vanite_axe", new ItemStack(NovaCraftItems.crystallized_vanite_axe), "XZZ", "WYZ", "VWX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_axe, 'Z', NovaCraftItems.crystallized_vanite_alloy, 'W', NovaCraftItems.ionizatior_powder, 'V', NovaCraftItems.crimson_dragon_bone);
		register("crystallized_vanite_shovel", new ItemStack(NovaCraftItems.crystallized_vanite_shovel), "XZZ", "WYZ", "VWX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_shovel, 'Z', NovaCraftItems.crystallized_vanite_alloy, 'W', NovaCraftItems.ionizatior_powder, 'V', NovaCraftItems.crimson_dragon_bone);
		register("crystallized_vanite_hoe", new ItemStack(NovaCraftItems.crystallized_vanite_hoe), "XZZ", "WYZ", "VWX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_hoe, 'Z', NovaCraftItems.crystallized_vanite_alloy, 'W', NovaCraftItems.ionizatior_powder, 'V', NovaCraftItems.crimson_dragon_bone);

		register("crystallized_vanite_helmet", new ItemStack(NovaCraftItems.crystallized_vanite_helmet), "ZWZ", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_helmet, 'Z', NovaCraftItems.crimson_scales, 'W', NovaCraftItems.crystallized_vanite_alloy, 'V', Items.diamond);
		register("crystallized_vanite_chestplate", new ItemStack(NovaCraftItems.crystallized_vanite_chestplate), "ZWZ", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_chestplate, 'Z', NovaCraftItems.crimson_scales, 'W', NovaCraftItems.crystallized_vanite_alloy, 'V', Items.diamond);
		register("crystallized_vanite_leggings", new ItemStack(NovaCraftItems.crystallized_vanite_leggings), "ZWZ", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_leggings, 'Z', NovaCraftItems.crimson_scales, 'W', NovaCraftItems.crystallized_vanite_alloy, 'V', Items.diamond);
		register("crystallized_vanite_boots", new ItemStack(NovaCraftItems.crystallized_vanite_boots), "ZWZ", "WYW", "XVX", 'X', new ItemStack(NovaCraftItems.superheated_magma_cream), 'Y', NovaCraftItems.tophinite_boots, 'Z', NovaCraftItems.crimson_scales, 'W', NovaCraftItems.crystallized_vanite_alloy, 'V', Items.diamond);
		...
		register("tophinite_hammer", new ItemStack(NovaCraftItems.tophinite_hammer), " WV", "XYW", "ZX ", 'X', NovaCraftItems.superheated_magma_cream, 'Y', NovaCraftItems.iridium_handle, 'Z', NovaCraftItems.deep_one_bone, 'W', NovaCraftItems.deepoid_horn, 'V', new ItemStack(NovaCraftBlocks.block_of_tophinite));
		...
		register("warden_helmet", new ItemStack(NovaCraftItems.warden_helmet), "ZDZ", "ABC", "YEY", 'D', new ItemStack(NovaCraftItems.klangite_ingot), 'C', new ItemStack(NovaCraftItems.iridium_helmet), 'B', new ItemStack(NovaCraftItems.sculk_dweller_heart), 'A', new ItemStack(NovaCraftItems.sculk_helmet), 'Z', new ItemStack(NovaCraftItems.beastly_leather), 'Y', new ItemStack(NovaCraftItems.corrupted_essence), 'E', new ItemStack(NovaCraftItems.warden_shard));
		register("warden_chestplate", new ItemStack(NovaCraftItems.warden_chestplate), "ZDZ", "ABC", "YEY", 'D', new ItemStack(NovaCraftItems.klangite_ingot), 'C', new ItemStack(NovaCraftItems.iridium_chestplate), 'B', new ItemStack(NovaCraftItems.sculk_dweller_heart), 'A', new ItemStack(NovaCraftItems.sculk_chestplate), 'Z', new ItemStack(NovaCraftItems.beastly_leather), 'Y', new ItemStack(NovaCraftItems.corrupted_essence), 'E', new ItemStack(NovaCraftItems.warden_shard));
		register("warden_leggings", new ItemStack(NovaCraftItems.warden_leggings), "ZDZ", "ABC", "YEY", 'D', new ItemStack(NovaCraftItems.klangite_ingot), 'C', new ItemStack(NovaCraftItems.iridium_leggings), 'B', new ItemStack(NovaCraftItems.sculk_dweller_heart), 'A', new ItemStack(NovaCraftItems.sculk_leggings), 'Z', new ItemStack(NovaCraftItems.beastly_leather), 'Y', new ItemStack(NovaCraftItems.corrupted_essence), 'E', new ItemStack(NovaCraftItems.warden_shard));
		register("warden_boots", new ItemStack(NovaCraftItems.warden_boots), "ZDZ", "ABC", "YEY", 'D', new ItemStack(NovaCraftItems.klangite_ingot), 'C', new ItemStack(NovaCraftItems.iridium_boots), 'B', new ItemStack(NovaCraftItems.sculk_dweller_heart), 'A', new ItemStack(NovaCraftItems.sculk_boots), 'Z', new ItemStack(NovaCraftItems.beastly_leather), 'Y', new ItemStack(NovaCraftItems.corrupted_essence), 'E', new ItemStack(NovaCraftItems.warden_shard));
