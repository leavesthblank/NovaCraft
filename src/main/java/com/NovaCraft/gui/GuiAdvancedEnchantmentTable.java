...
public class GuiAdvancedEnchantmentTable extends GuiContainer
{
    ...
    public GuiAdvancedEnchantmentTable(InventoryPlayer p_i1090_1_, World world, int p_i1090_3_, int p_i1090_4_, int p_i1090_5_, String p_i1090_6_)
    {
        super(new AdvancedEnchantmentTableContainer(p_i1090_1_, world, p_i1090_3_, p_i1090_4_, p_i1090_5_));
