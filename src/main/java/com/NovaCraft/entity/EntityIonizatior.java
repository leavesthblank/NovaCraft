        ...
        if (this.attackTime <= 0 && distance < 2.0F && target.boundingBox.maxY > this.boundingBox.minY && target.boundingBox.minY < this.boundingBox.maxY) {
            ...
            if (this.attackTime == 0) {
                ...
                if (this.field_70846_g > 1) {
                    ...
                    for (int i = 0; i < 4; ++i) {
                        EntityIonizatiorProjectile projectile = new EntityIonizatiorProjectile(this.worldObj, this, dx + this.rand.nextGaussian() * spread, dy, dz + this.rand.nextGaussian() * spread);
