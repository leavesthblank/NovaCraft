...
{
    private static final ResourceLocation texture = new ResourceLocation("nova_craft","textures/entity/legendary_enchanting_table_book.png");
    private ModelBook field_147541_c = new ModelBook();

    public void renderTileEntityAt(TileEntityLegendaryEnchantmentTable tile_entity, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderTileEntityAt((TileEntityLegendaryEnchantmentTable)tile_entity, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
    }
}
