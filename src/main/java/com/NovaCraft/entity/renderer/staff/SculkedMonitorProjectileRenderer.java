...
public class SculkedMonitorProjectileRenderer extends Render {
    ...
    public void doRenderProjectile(EntitySculkedMonitorProjectile projectile, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double par2, double par4, double par6, float par8, float par9) {
        this.doRenderProjectile((EntitySculkedMonitorProjectile) entity, par2, par4, par6, par8, par9);
    }
