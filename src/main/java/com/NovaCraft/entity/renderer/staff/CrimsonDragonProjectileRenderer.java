...
public class CrimsonDragonProjectileRenderer extends Render {

    public CrimsonDragonProjectileRenderer() {
        super();

        this.shadowSize = 0.0F;
    }

    public void doRenderNew(EntityCrimsonDragonProjectile entity, double par2, double par4, double par6, float par8, float par9) {
        GL11.glPushMatrix();
    ...
    protected ResourceLocation getEntityTexture(Entity entity) {
        return NovaCraft.locate("textures/entity/crimson_dragon/crimson_dragon_fireball.png");
    }
