...
public class PrimedPETNRenderer extends Render
{
    ...
    public void doRender(final Entity entity, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        this.doRender((EntityPrimedPETN)entity, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    
    public void doRender(final EntityPrimedPETN entity, final double p_76986_2_, final double p_76986_4_, final double p_76986_6_, final float p_76986_8_, final float p_76986_9_) {
        GL11.glPushMatrix();
        ...
        this.blockRenderer.renderBlockAsItem(NovaCraftBlocks.PETN, 0, entity.getBrightness(p_76986_9_));
    ...
    protected ResourceLocation getEntityTexture(final Entity entity) {
        return this.getEntityTexture((EntityPrimedPETN)entity);
    }
    
    protected ResourceLocation getEntityTexture(final EntityPrimedPETN entity) {
