...
public class CrimsonDragonModel extends ModelBase {
    ...
    public void render(Entity entity, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_) {
        ...
        float f10 = 0.0F;
        float f11 = 1.5F;
        double[] adouble = EntityCrimsonDragon.getMovementOffsets(6, this.partialTicks);
        float f12 = this.updateRotations(EntityCrimsonDragon.getMovementOffsets(5, this.partialTicks)[0] - EntityCrimsonDragon.getMovementOffsets(10, this.partialTicks)[0]);
        float f13 = this.updateRotations(EntityCrimsonDragon.getMovementOffsets(5, this.partialTicks)[0] + (double)(f12 / 2.0F));
        f8 += 2.0F;
        ...
        for (int i = 0; i < 5; ++i)
        {
            double[] adouble1 = EntityCrimsonDragon.getMovementOffsets(5 - i, this.partialTicks);
        ...
        double[] adouble2 = EntityCrimsonDragon.getMovementOffsets(0, this.partialTicks);
        ...
        f9 = 60.0F;
        f10 = 0.0F;
        adouble = EntityCrimsonDragon.getMovementOffsets(11, this.partialTicks);

        for (int k = 0; k < 12; ++k)
        {
            adouble2 = EntityCrimsonDragon.getMovementOffsets(12 + k, this.partialTicks);
