package com.NovaCraft.entity.CrimsonDragon;

import java.util.Iterator;
import java.util.List;
import com.NovaCraft.Items.NovaCraftItems;
import com.NovaCraft.entity.DeepoidDragon.EntityDeepoidDragonPart;
import com.NovaCraft.entity.DeepoidDragon.GIEntityMultiPart;
import com.NovaCraft.entity.EntitySoloid;
import com.NovaCraft.entity.EntityWyrmling;
import com.NovaCraft.entity.misc.EntityCrimsonDragonProjectile;
...
public class EntityCrimsonDragon extends EntityFlying implements IBossDisplayData, GIEntityMultiPart, IMob
{
    ...
    public int rangedBurstTicks = 0;
    private int rangedCooldown = 0;
    private boolean lockingYawForAttack = false;
    ...
    public void FireBreath() {
        if (this.worldObj.isRemote) {
            ...
            double py = this.posY + 0.75 + look.yCoord * dist;
            ...
            for (int i = 0; i < 6; i++)
            {
                ...
                ParticleHandler.REGULARFLAMELARGE.spawn(worldObj, px, py, pz, -dx, dy, -dz, 0.0f, new Object[0]);
            }
        }
    }
            ...
            if(!((entity instanceof EntityWyrmling) || (entity instanceof EntitySoloid))) {
                ...
                if (entity instanceof EntityLivingBase)
                {
...

                    {
                        ...
                        {
                            entity.setFire(20);
                            entity.attackEntityFrom(DamageSource.inFire, 30.0F);
    ...
    public boolean attackEntityFrom(DamageSource ds, float i) {
        if (ds.getEntity() instanceof EntityPlayer) {
            ...
            if (entity instanceof EntityPlayer)
            {
                ...
                int random1 = (int)(1 + Math.random() * 20);
                if(random1 == 1 ) {
                    EntityWyrmling ion = new EntityWyrmling(this.worldObj);
    ...
    protected void updateRangedAttack() {
        ...
        if (target == null) {
            ...
            this.setAttackTarget(this.worldObj.getClosestVulnerablePlayerToEntity(this, 500D));
            return;
        }
        ...
        if (this.getDistanceSqToEntity(target) < 4096.0D && this.canEntityBeSeen(target)) {
            double dx = target.posX - this.posX;
            double dy = (target.boundingBox.minY + target.height * 0.5F) - (this.posY + this.height * 0.5F);
            double dz = target.posZ - this.posZ;

            ++this.attackCounter;

            if (this.attackCounter == 10) {
                this.playSound("fire.fire", 3F, this.base);
            }

            if (this.attackCounter >= 20 && this.attackCounter % 10 == 0 && rangedBurstTicks < 4) {
                this.playSound("fire.fire", 3F, this.base);

                this.lockingYawForAttack = true;
                this.rotateForBurst = true;
                ...
                double spawnDist = 6.0D;
                double px = this.posX + nx * spawnDist;
                double py = this.posY + this.height * 0.5D + 0.5D;
                double pz = this.posZ + nz * spawnDist;

                EntityCrimsonDragonProjectile projectile = new EntityCrimsonDragonProjectile(this.worldObj, this, dx, dy, dz);
                projectile.setPosition(px, py, pz);

                if (!this.worldObj.isRemote) {
                    projectile.setThrowableHeading(nx, ny, nz, 1.2F, 0.0F);
                    this.worldObj.spawnEntityInWorld(projectile);
                    rangedBurstTicks++;
                }
            }

            if (rangedBurstTicks >= 4) {
                this.attackCounter = 0;
                this.rangedBurstTicks = 0;
                this.rangedCooldown = 80;
                this.lockingYawForAttack = false;
            }
    ...
    private void createloot(int p_70975_1_, int p_70975_2_, int p_70975_3_) {
        ...
        this.worldObj.setBlock(p_70975_1_, p_70975_2_ - 1, p_70975_3_, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ - 1, p_70975_2_ - 1, p_70975_3_, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ + 1, p_70975_2_ - 1, p_70975_3_, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_, p_70975_2_ - 1, p_70975_3_ - 1, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_, p_70975_2_ - 1, p_70975_3_ + 1, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ - 1, p_70975_2_ - 1, p_70975_3_ + 1, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ - 1, p_70975_2_ - 1, p_70975_3_ - 1, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ + 1, p_70975_2_ - 1, p_70975_3_ + 1, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ + 1, p_70975_2_ - 1, p_70975_3_ - 1, NovaCraftBlocks.glowing_obsidian);

        this.worldObj.setBlock(p_70975_1_ - 2, p_70975_2_ - 1, p_70975_3_, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_ + 2, p_70975_2_ - 1, p_70975_3_, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_, p_70975_2_ - 1, p_70975_3_ - 2, NovaCraftBlocks.glowing_obsidian);
        this.worldObj.setBlock(p_70975_1_, p_70975_2_ - 1, p_70975_3_ + 2, NovaCraftBlocks.glowing_obsidian);
