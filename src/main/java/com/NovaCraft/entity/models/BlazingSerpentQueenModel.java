...
public class BlazingSerpentQueenModel extends ModelBase
{
	ModelRenderer Head1;
    ...
    public BlazingSerpentQueenModel() {
        ...
        (this.Crown1 = new ModelRenderer((ModelBase)this, 59, 32)).addBox(-2.0f, -28.0f, 16.0f, 4, 4, 0); // -- -13.0f  z22
        this.Crown1.setRotationPoint(0.0f, 19.0f, -24.0f);
        this.Crown1.setTextureSize(128, 64);
        this.Crown1.mirror = true;
        this.Head1.addChild(Crown1);
        
        (this.Crown2 = new ModelRenderer((ModelBase)this, 59, 32)).addBox(-2.0f, -28.0f, 23.0f, 4, 4, 0); //z29
        this.Crown2.setRotationPoint(0.0f, 19.0f, -24.0f);
        this.Crown2.setTextureSize(128, 64);
        this.Crown2.mirror = true;
        this.Head1.addChild(Crown2);
        
        (this.Crown3 = new ModelRenderer((ModelBase)this, 55, 31)).addBox(-2.0f, -28.0f, 16.0f, 0, 4, 7); //z22
        this.Crown3.setRotationPoint(0.0f, 19.0f, -24.0f);
        this.Crown3.setTextureSize(128, 64);
        this.Crown3.mirror = true;
        this.Head1.addChild(Crown3);
        
        (this.Crown4 = new ModelRenderer((ModelBase)this, 55, 31)).addBox(2.0f, -28.0f, 16.0f, 0, 4, 7, 0.0F); //z22
        this.Crown4.setRotationPoint(0.0f, 19.0f, -24.0f);
        this.Crown4.setTextureSize(128, 64);
        this.Crown4.mirror = true;        
        this.Head1.addChild(Crown4);
