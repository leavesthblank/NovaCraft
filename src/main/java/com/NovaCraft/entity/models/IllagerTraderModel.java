...
public class IllagerTraderModel extends ModelBiped
{

    public IllagerTraderModel()
    {
        this(0.0F, 0.0F, false);
    }

    public IllagerTraderModel(float p_i1165_1_, float p_i1165_2_, boolean p_i1165_3_)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        ...
        if (entity instanceof EntityIllagerTrader) {
        	EntityIllagerTrader vindicator = (EntityIllagerTrader) entity;
