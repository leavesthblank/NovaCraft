...
public class TheDeepOneModel extends ModelBase {
	...
	public TheDeepOneModel() {
        ...
        this.top_right_leg.addBox(-37.2531F, -15.3189F, -1.0F, 5, 5, 5, 0.0f);
        this.setRotationAngle(this.top_right_leg, 0.0872F, 0.0F, -0.0872F); //-0.0F, 0.0F, -0.0872F
        ...
        this.setRotationAngle(this.bottom_right_leg, 0.0872F, 0.0F, 0.0436F); // 0 0.0F, 0.0436F
        
        (this.back_right_leg = new ModelRenderer((ModelBase)this, 37, 52)).setRotationPoint(21.0F, 1.00F, 12.0F);
        this.back_right_leg.addBox(-37.2531F, -15.3189F, -1.0F, 5, 5, 5, 0.0f);
	...
	public void setRotationAngles(final float limbSwing, final float limbSwingAmount, final float ageInTicks, final float netHeadYaw, final float headPitch, final float scaleFactor, final Entity entityIn) {
	    ...
	    if (entityIn instanceof EntityDeepoidDragon) {
	        EntityDeepoidDragon dragon = (EntityDeepoidDragon) entityIn;
