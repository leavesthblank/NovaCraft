...
public class IllagerChiefModel extends ModelBiped
{
    ...
    public IllagerChiefModel(float p_i1165_1_, float p_i1165_2_, boolean p_i1165_3_)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        ...
        if (entity instanceof EntityIllagerChief) {
        	EntityIllagerChief vindicator = (EntityIllagerChief) entity;
