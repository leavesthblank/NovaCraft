...
public class EntityEchoEye extends Entity {
    ...
    public void onUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.despawnTimer > 120 && !this.worldObj.isRemote)
            {
                ...
                {
                    this.worldObj.spawnEntityInWorld(new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, new ItemStack(NovaCraftItems.echo_eye)));
                }
                else
                {
