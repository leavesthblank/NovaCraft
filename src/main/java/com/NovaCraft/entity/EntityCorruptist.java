...
public class EntityCorruptist extends EntityMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setBaseValue(3.40D);
    ...
    public boolean attackEntityAsMob(final Entity entity) {
        ...
        ((EntityLivingBase) entity).addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 750, 2));
    ...
    public void shootTarget() {
        ...
        EntityIceProjectile entityarrow = new EntityIceProjectile(this.worldObj, this, 4.0F);
    ...
    protected void addRandomArmor() {
        this.setCurrentItemOrArmor(0, new ItemStack(NovaCraftItems.vanite_scythe));
    }
