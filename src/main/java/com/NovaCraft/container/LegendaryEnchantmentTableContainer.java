...
public class LegendaryEnchantmentTableContainer extends Container
{
    ...
    public LegendaryEnchantmentTableContainer(InventoryPlayer inventory, World world, int x, int y, int z)
    {
    ...
    public void updateProgressBar(int p_75137_1_, int p_75137_2_)
    {
        ...
        {
            this.enchantLevels[p_75137_1_] = 90;
        }
        else
        {
    ...
    public boolean enchantItem(EntityPlayer p_75140_1_, int p_75140_2_)
    {
        ...
        if (this.enchantLevels[p_75140_2_] > 0 && itemstack != null && (p_75140_1_.experienceLevel >= 90 || p_75140_1_.capabilities.isCreativeMode))
        {
            if (!this.worldPointer.isRemote)
            {
                ...
                if (list != null)
                {
                    p_75140_1_.addExperienceLevel(-90);
    ...
    {
        return this.worldPointer.getBlock(this.posX, this.posY, this.posZ) != NovaCraftBlocks.legendary_enchantment_table ? false : player.getDistanceSq((double)this.posX + 0.5D, (double)this.posY + 0.5D, (double)this.posZ + 0.5D) <= 64.0D;
    }
