...
public class BlockMassiveNullstoneStalagmiteBottom extends Block {

    public BlockMassiveNullstoneStalagmiteBottom() {
        super(Material.rock);
        this.setHardness(0.3F);
        this.setResistance(0.3F);
        this.setBlockBounds(0.1F, 0.0F, 0.1F, 0.8F, 1.0F, 0.8F);
    ...
    protected boolean canPlaceBlockOn(Block block) {
        return block == NovaCraftBlocks.nullstone;
    }
    ...
    public void onBlockDestroyedByPlayer(World world, int x, int y, int z, int l) {
        if (world.getBlock(x, y + 1, z) == NovaCraftBlocks.massive_nullstone_stalagmite_top) {
