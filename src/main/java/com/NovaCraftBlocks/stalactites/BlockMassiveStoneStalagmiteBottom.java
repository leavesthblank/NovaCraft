...
public class BlockMassiveStoneStalagmiteBottom extends Block {

    public BlockMassiveStoneStalagmiteBottom() {
        super(Material.rock);
    ...
    public void onBlockDestroyedByPlayer(World world, int x, int y, int z, int l) {
        if (world.getBlock(x, y + 1, z) == NovaCraftBlocks.massive_stone_stalagmite_top) {
