...
public class BlockMassiveNullstoneStalactiteTop extends Block {

    public BlockMassiveNullstoneStalactiteTop() {
        super(Material.rock);
    ...
    public void onBlockDestroyedByPlayer(World world, int x, int y, int z, int l) {
        if (world.getBlock(x, y - 1, z) == NovaCraftBlocks.massive_nullstone_stalactite_bottom) {
