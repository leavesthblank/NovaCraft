...
public class BlockEchoCluster extends BlockEcho implements ISubBlocksBlock {
	...
	protected boolean canPlaceBlockOn(Block block)
	  {
	       return block == (NovaCraftBlocks.budding_echo_block);
	  }
   ...
   public Item getItemDropped(int p_149650_1_, Random random, int p_149650_3_)
   {
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		icons = new IIcon[2];
		if(type == 0) {
			icons[0] = iconRegister.registerIcon("nova_craft:echo_bud");
			icons[1] = iconRegister.registerIcon("nova_craft:small_echo_bud");
		}
		if(type == 1) {
			icons[0] = iconRegister.registerIcon("nova_craft:medium_large_echo_bud");
			icons[1] = iconRegister.registerIcon("nova_craft:echo_cluster");
		}
