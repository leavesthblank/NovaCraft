...
public class BlockTsavorokiteCluster extends BlockTsavorokite implements ISubBlocksBlock {
   ...
   public Item getItemDropped(int p_149650_1_, Random random, int p_149650_3_)
   {
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		icons = new IIcon[2];
		if(type == 0) {
			icons[0] = iconRegister.registerIcon("nova_craft:tsavorokite_bud");
			icons[1] = iconRegister.registerIcon("nova_craft:tsavorokite_medium_bud");
		}
		if(type == 1) {
			icons[0] = iconRegister.registerIcon("nova_craft:tsavorokite_large_bud");
			icons[1] = iconRegister.registerIcon("nova_craft:tsavorokite_cluster");
		}
